...
When the import is done, the tool creates a file called `errors_{timestamp}` in the directory where it was run where we can find the issues found during the import.
